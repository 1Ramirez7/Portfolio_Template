...
2. In the instructions for the video "Working with Python…part 1," follow and only do steps 1 to 1.9 (watch the first video). Watch the beginning of the second video until I get to the part about installing Python code, just so you understand more about environments and Python code.  
